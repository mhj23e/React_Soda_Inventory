...
const columns: GridColDef[] = [
    ...
    { field: 'name', headerName: 'Soda Name', flex: 1 },
...
export const DataTable = () => {
    ...
    return (
        ...
        <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
            <DialogTitle id="form-dialog-title">Update Soda {selectionModel}</DialogTitle>
            <DialogContent>
                <DialogContentText>Update C</DialogContentText>
